...
function AdminBlog() {
  ...
  const blogsData = fetchBlogs?.blogs;
    ...
    <div className="relative px-[5rem] mt-[5rem] pb-[10.5rem]">
      <div className="flex w-full items-center justify-between">
        <div className="flex flex-col gap-4">
          <p className="uppercase font-bold text-[1.5rem] text-white">Blogs</p>
      ...
      {isLoading ? (
        Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className="w-full mt-7">
            <div className="bg-[#222] rounded-[8.75rem] px-8 py-2 flex items-center justify-between">
